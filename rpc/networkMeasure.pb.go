...
func NewNetworkMeasureClient(cc grpc.ClientConnInterface) NetworkMeasureClient {
...
// UnimplementedNetworkMeasureServer can be embedded to have forward compatible implementations.
type UnimplementedNetworkMeasureServer struct {
}

func (*UnimplementedNetworkMeasureServer) PredictLatency(ctx context.Context, req *LatencyRequest) (*LatencyReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PredictLatency not implemented")
}
