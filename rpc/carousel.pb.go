...
type FastCommitRequest struct {
	CommitRequest        *CommitRequest `protobuf:"bytes,1,opt,name=commitRequest,proto3" json:"commitRequest,omitempty"`
...
func (m *FastCommitRequest) Reset()         { *m = FastCommitRequest{} }
func (m *FastCommitRequest) String() string { return proto.CompactTextString(m) }
func (*FastCommitRequest) ProtoMessage()    {}
func (*FastCommitRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cd83e540b198e190, []int{22}
}

func (m *FastCommitRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_FastCommitRequest.Unmarshal(m, b)
}
func (m *FastCommitRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_FastCommitRequest.Marshal(b, m, deterministic)
}
func (m *FastCommitRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FastCommitRequest.Merge(m, src)
}
func (m *FastCommitRequest) XXX_Size() int {
	return xxx_messageInfo_FastCommitRequest.Size(m)
}
func (m *FastCommitRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_FastCommitRequest.DiscardUnknown(m)
}

var xxx_messageInfo_FastCommitRequest proto.InternalMessageInfo

func (m *FastCommitRequest) GetCommitRequest() *CommitRequest {
	if m != nil {
...
func (m *FastCommitRequest) GetTimestamp() int64 {
	if m != nil {
		return m.Timestamp
	}
	return 0
...
func (m *FastCommitReply) Reset()         { *m = FastCommitReply{} }
func (m *FastCommitReply) String() string { return proto.CompactTextString(m) }
func (*FastCommitReply) ProtoMessage()    {}
func (*FastCommitReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_cd83e540b198e190, []int{23}
}

func (m *FastCommitReply) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_FastCommitReply.Unmarshal(m, b)
}
func (m *FastCommitReply) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_FastCommitReply.Marshal(b, m, deterministic)
}
func (m *FastCommitReply) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FastCommitReply.Merge(m, src)
}
func (m *FastCommitReply) XXX_Size() int {
	return xxx_messageInfo_FastCommitReply.Size(m)
}
func (m *FastCommitReply) XXX_DiscardUnknown() {
	xxx_messageInfo_FastCommitReply.DiscardUnknown(m)
}

var xxx_messageInfo_FastCommitReply proto.InternalMessageInfo

func (m *FastCommitReply) GetLeaderId() int32 {
	if m != nil {
		return m.LeaderId
	}
	return 0
...
type FastAbortRequest struct {
	AbortRequest         *AbortRequest `protobuf:"bytes,1,opt,name=abortRequest,proto3" json:"abortRequest,omitempty"`
	Timestamp            int64         `protobuf:"varint,2,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
...
func (m *FastAbortRequest) Reset()         { *m = FastAbortRequest{} }
func (m *FastAbortRequest) String() string { return proto.CompactTextString(m) }
func (*FastAbortRequest) ProtoMessage()    {}
func (*FastAbortRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cd83e540b198e190, []int{26}
}

func (m *FastAbortRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_FastAbortRequest.Unmarshal(m, b)
}
func (m *FastAbortRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_FastAbortRequest.Marshal(b, m, deterministic)
}
func (m *FastAbortRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FastAbortRequest.Merge(m, src)
}
func (m *FastAbortRequest) XXX_Size() int {
	return xxx_messageInfo_FastAbortRequest.Size(m)
}
func (m *FastAbortRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_FastAbortRequest.DiscardUnknown(m)
}

var xxx_messageInfo_FastAbortRequest proto.InternalMessageInfo

func (m *FastAbortRequest) GetAbortRequest() *AbortRequest {
	if m != nil {
		return m.AbortRequest
	}
	return nil
}

func (m *FastAbortRequest) GetTimestamp() int64 {
	if m != nil {
		return m.Timestamp
	}
	return 0
...
func (m *FastAbortReply) Reset()         { *m = FastAbortReply{} }
func (m *FastAbortReply) String() string { return proto.CompactTextString(m) }
func (*FastAbortReply) ProtoMessage()    {}
func (*FastAbortReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_cd83e540b198e190, []int{27}
}

func (m *FastAbortReply) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_FastAbortReply.Unmarshal(m, b)
}
func (m *FastAbortReply) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_FastAbortReply.Marshal(b, m, deterministic)
}
func (m *FastAbortReply) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FastAbortReply.Merge(m, src)
}
func (m *FastAbortReply) XXX_Size() int {
	return xxx_messageInfo_FastAbortReply.Size(m)
}
func (m *FastAbortReply) XXX_DiscardUnknown() {
	xxx_messageInfo_FastAbortReply.DiscardUnknown(m)
}

var xxx_messageInfo_FastAbortReply proto.InternalMessageInfo

func (m *FastAbortReply) GetLeaderId() int32 {
	if m != nil {
		return m.LeaderId
	}
	return 0
...
func (*ProbeReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_cd83e540b198e190, []int{31}
}
...
func (*ProbeTimeReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_cd83e540b198e190, []int{32}
}
...
func (*StartProbeReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_cd83e540b198e190, []int{33}
}
...
func (*WriteDataRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cd83e540b198e190, []int{34}
}
...
func init() {
	...
	proto.RegisterType((*FastCommitRequest)(nil), "rpc.FastCommitRequest")
	proto.RegisterType((*FastCommitReply)(nil), "rpc.FastCommitReply")
	proto.RegisterType((*AbortRequest)(nil), "rpc.AbortRequest")
	proto.RegisterType((*AbortReply)(nil), "rpc.AbortReply")
	proto.RegisterType((*FastAbortRequest)(nil), "rpc.FastAbortRequest")
	proto.RegisterType((*FastAbortReply)(nil), "rpc.FastAbortReply")
...
var fileDescriptor_cd83e540b198e190 = []byte{
	...
	,
}
...
type CarouselClient interface {
	...
	// fast commit
	FastCommit(ctx context.Context, in *FastCommitRequest, opts ...grpc.CallOption) (*FastCommitReply, error)
	FastAbort(ctx context.Context, in *FastAbortRequest, opts ...grpc.CallOption) (*FastAbortReply, error)
...
func (c *carouselClient) FastCommit(ctx context.Context, in *FastCommitRequest, opts ...grpc.CallOption) (*FastCommitReply, error) {
	out := new(FastCommitReply)
	err := c.cc.Invoke(ctx, "/rpc.Carousel/FastCommit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *carouselClient) FastAbort(ctx context.Context, in *FastAbortRequest, opts ...grpc.CallOption) (*FastAbortReply, error) {
	out := new(FastAbortReply)
	err := c.cc.Invoke(ctx, "/rpc.Carousel/FastAbort", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CarouselServer interface {
	...
	// fast commit
	FastCommit(context.Context, *FastCommitRequest) (*FastCommitReply, error)
	FastAbort(context.Context, *FastAbortRequest) (*FastAbortReply, error)
	// once expected leader is selected start to probe the latency
...
func (*UnimplementedCarouselServer) FastCommit(ctx context.Context, req *FastCommitRequest) (*FastCommitReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FastCommit not implemented")
}
func (*UnimplementedCarouselServer) FastAbort(ctx context.Context, req *FastAbortRequest) (*FastAbortReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FastAbort not implemented")
}
...
func _Carousel_FastCommit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FastCommitRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CarouselServer).FastCommit(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rpc.Carousel/FastCommit",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CarouselServer).FastCommit(ctx, req.(*FastCommitRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Carousel_FastAbort_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FastAbortRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CarouselServer).FastAbort(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rpc.Carousel/FastAbort",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CarouselServer).FastAbort(ctx, req.(*FastAbortRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Carousel_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FastCommit",
			Handler:    _Carousel_FastCommit_Handler,
		},
		{
			MethodName: "FastAbort",
			Handler:    _Carousel_FastAbort_Handler,
		},
		{
