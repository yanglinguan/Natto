...
type TwoPLApplyPrepareReplicationMsg struct {
	msg *ReplicationMsg
}

func NewTwoPLApplyPrepareReplicationMsg(msg *ReplicationMsg) *TwoPLApplyPrepareReplicationMsg {
	r := &TwoPLApplyPrepareReplicationMsg{msg: msg}
	return r
}

func (p *TwoPLApplyPrepareReplicationMsg) Execute(storage *Storage) {
...
func (p *TwoPLApplyPrepareReplicationMsg) fastPathExecution(storage *Storage) {
